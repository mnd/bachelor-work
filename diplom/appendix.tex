...
\appendix
\chapter{Реализация и описание метаязыка}
...
\chapter{Реализация генератора кода на Template Haskell}
...
\chapter{Программа генерирующая основной модуль системы}
...
\chapter{Библиотека для совместного использования динамических функций.}
